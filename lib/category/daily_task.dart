...
class _TodolistState extends State<Todolist> {
  ...
  void removeTask(int index) {
    setState(() {
      dailyListData.removeAt(index); // remove task from the list based on index
    });
  }
  ...
  void moveTask(int index) {
    setState(() {
      if (dailyListData[index].listStatus == "done") {
        dailyListData[index].listStatus = "todo";
      } else {
        dailyListData[index].listStatus = "done";
      }
    });
  }
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            if (dailyListData[index].listStatus == "todo") {
                              return Card(
                ...
                // if (dailyListData.contains(ListModel(listTitle: "", listStatus: "todo")))
                sectionTitle('Done'),
                ListView.builder(
                  shrinkWrap: true,
                  physics: const NeverScrollableScrollPhysics(),
